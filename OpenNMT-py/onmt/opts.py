...
def train_opts(parser):
    ...
    group.add('--min_lr', '-min_lr', type=float, default=0,
              help='Minimum Learning Rate')
    group.add('--warmup_init_lr', '-warmup_init_lr', type=float, default=0,
              help='Warm up init lr')
    group.add('--warmup_end_lr', '-warmup_end_lr', type=float, default=0,
              help='Warm up end lr')
    ...
    group.add('--optim', '-optim', default='sgd',
              choices=['sgd', 'adagrad', 'adadelta', 'adam', 'radam',
...
def translate_opts(parser):
    ...
    group.add('--langcode', '-langcode', type=str,
              help="Language code for the target language")
